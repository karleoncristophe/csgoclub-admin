...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageTitle subtitle="Preferências regionais do painel administrativo.">
        Configurações
      </PageTitle>
      ...
      <Surface variant="settingsPanel" className="!p-5">
        ...
        <Surface variant="settingsPanel" className="mt-6 !p-4">
          ...
          <ThemeText as="p" tone="secondary" className="mt-1 text-sm">
            ...
            <strong>
              {SKINS_CURRENCY_OPTIONS.find((o) => o.value === suggestedCurrency)?.label}
            </strong>
          </ThemeText>
          <ThemeText as="p" tone="secondary" className="mt-1 text-sm">
            Moeda ativa no admin:{' '}
            <strong>
              {SKINS_CURRENCY_OPTIONS.find((o) => o.value === skinsCurrency)?.label}
            </strong>
          </ThemeText>
